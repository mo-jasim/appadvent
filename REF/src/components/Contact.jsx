...
import arro from "../assets/image/ArrowRight11.png"
import bgimg from "../assets/image/Polygon 1 (2) - Copy.png"
const Contact = () => {
  return (
      <div className=" w-full min-h-screen mt-40  md:-mt-8 relative">
 <img
    src={bgimg}
    alt="Industry Background"
    className="absolute inset-0 ml-64 w-[550px] h-[630px] opacity-30 z-20" 
  />
     <div className="relative z-10 min-h-screen bg-gradient-to-r from-black via-gray-900 to-black text-white p-6 sm:p-6 md:p-8 flex flex-col lg:flex-row items-center justify-center gap-8">
      <div className=" md:w-4/2 flex flex-col items-center md:items-start text-center   lg:px-10 md:text-start">
        ...
        <p className=" text-sm sm:text-base ml-2 text-center lg:text-start text-gray-400 mb-8 font-thicccboi">
      ...
      <div className="bg-white  text-[rgba(131,142,158,1)] rounded-[24px] shadow-lg p-6 sm:p-8 w-full sm:w-[500px] md:w-[800px] lg:w-[800px]">
