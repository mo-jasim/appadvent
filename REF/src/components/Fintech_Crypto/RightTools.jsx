  ...
  return (
    ...
    >
      <div className="relative z-10 py-16 px-6 md:px-10 lg:px-6 flex flex-col md:flex-row items-center justify-center max-w-7xl mx-auto gap-10">
        ...
        <ul className="space-y-3 text-white font-[THICCCBOI] text-[18px] leading-[140%]">
  <li className="flex items-center gap-2 p-3 rounded-lg hover:bg-[#32B9E9] hover:shadow-md transition-all duration-300">
