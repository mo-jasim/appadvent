...
import bgpor from "../../assets/image/bgnew.png"
const Portfoliopage3 = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r mt-8 sm:mt-4 md:mt-8 lg:-mt-10 from-black via-gray-900 to-black text-white p-6 sm:p-6 md:p-8 flex flex-col lg:flex-row items-center justify-center gap-8">
