...
const HomePage = () => {
  ...
  // Hero title words for stagger animation
  const heroWords = "Create AI-Driven Mobile, Web & Software Solutions – From Concept to Growth".split(" ");

  return (
    <main className="relative w-full ">
      {/* ═══════════════ HERO SECTION ═══════════════ */}
      <section className="relative w-full overflow-hidden font-THICCCBOI bg-[#04203c] min-h-screen flex flex-col justify-between">
        {/* Background image + dark overlay */}
        <div
          className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat"
          style={{ backgroundImage: "url('/bg-image2.png')" }}
        >
          <div className="absolute inset-0 bg-[#04203c]/30" />
        </div>

        <div className="relative z-10 pt-28 pb-8 md:pt-36 md:pb-10 px-4 flex-grow flex flex-col items-center justify-center text-center">
          <motion.h1
            className="max-w-5xl mx-auto text-white font-bold text-[32px] sm:text-[38px] md:text-[45px] text-center leading-tight"
            initial="hidden"
            animate="visible"
            variants={{
              hidden: {},
          ...
          <motion.p
            className="max-w-5xl mx-auto mt-5 text-white/80 text-center text-[17px] sm:text-[17px]"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5, duration: 0.6 }}
          >
            We help startups and enterprises transform ideas into AI-powered mobile, web, and software products.
          </motion.p>
        ...
        {/* Stats bar */}
        <motion.div
          className="relative z-10 border-t border-white/15 backdrop-blur-sm"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, margin: "-20px" }}
          variants={staggerContainer}
        >
          <div className="max-w-6xl mx-auto grid grid-cols-3 divide-x divide-white/15 py-4 sm:py-5 px-4">
            {[
              { value: 4, suffix: "+", label: "Years of experience" },
              { value: 20, suffix: "+", label: "Expert team members" },
              { value: 100, suffix: "+", label: "Clients satisfaction" },
            ].map((stat) => (
              <motion.div key={stat.label} variants={cardVariant} className="text-center px-2">
                <p className="text-white font-bold text-[22px] sm:text-[28px]">
                  <AnimatedCounter target={stat.value} suffix={stat.suffix} />
                </p>
                <p className="text-white/80 text-[12px] sm:text-[14px] mt-0.5 font-medium">{stat.label}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
      ...
      <section className="w-full bg-white py-16 md:py-24 font-THICCCBOI">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.p
            className="max-w-2xl mx-auto text-black font-bold text-[32px] md:text-[40px] leading-tight text-center"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-60px" }}
            transition={{ duration: 0.6, ease: [0.25, 0.46, 0.45, 0.94] }}
          ...
          <motion.p
            className="max-w-7xl mx-auto text-[#061C3D] pt-5 text-center text-[16px] md:text-[18px]"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-60px" }}
            transition={{ duration: 0.6, delay: 0.15, ease: [0.25, 0.46, 0.45, 0.94] }}
          ...
          {/* Service Cards — matching Figma design */}
          <motion.div
            className="mt-10 grid gap-8 w-full grid-cols-1 sm:grid-cols-2 lg:grid-cols-3"
            initial="hidden"
            whileInView="visible"
                  ...
                  <Link href={service.href} className="block h-full group" onMouseEnter={() => handleHover(index)}>
                    <div className="relative h-full rounded-[24px] border border-gray-100 bg-white p-7 shadow-sm flex flex-col items-center justify-between">
                      ...
                      <div className="flex flex-col items-center flex-grow">
                        ...
                        {/* Title */}
                        <p className="text-[#061C3D] font-bold text-center text-[19px] leading-snug">
                          {service.title}
                        </p>
      ...
      {/* ═══════════════ INDUSTRIES — MATCHING FIGMA DESIGN ═══════════════ */}
      <section className="w-full bg-[#EAF8FD] py-16 md:py-24 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10 md:mb-12">
          <motion.h2
            className="text-[#061C3D] font-bold text-[34px] sm:text-[42px] md:text-[48px] leading-tight font-THICCCBOI"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-60px" }}
          ...
          <motion.p
            className="text-[#4A5568] text-[16px] sm:text-[18px] leading-relaxed max-w-2xl mt-4 font-THICCCBOI"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-60px" }}
