...
const highlightsData = [
    {
        ...
        desc: "Capture photos and videos that are stored securely inside protected private folders within the app.",
        phone: "/caseimg/Privi-iPhone1.svg",
    },
    {
        id: "02",
        title: "Biometric & Password Protection",
        desc: "Keep sensitive content safe with advanced fingerprint, Face ID, and password-based authentication security.",
        phone: "/caseimg/Privi-iPhone2.svg",
    },
    {
        id: "03",
        title: "No Cloud Uploads",
        desc: "Ensure complete privacy by storing all media locally on your device without third-party cloud access.",
        phone: "/caseimg/Privi-iPhone3.svg",
    },
    {
        id: "04",
        title: "RSecure Camera Experience",
        desc: "Take photos and record videos confidently with a privacy-focused camera built for personal security.",
        phone: "/caseimg/Privi-iPhone4.svg",
    },
    {
        id: "05",
        title: "Organized Private Gallery",
        desc: "Manage and organize confidential photos and videos easily through dedicated secure media folders.",
        phone: "/caseimg/Privi-iPhone5.svg",
    },
    {
        id: "06",
        title: "Private & Secure Chat System",
        desc: "Communicate safely through built-in private chat functionality designed for confidential conversations and sharing.",
        phone: "/caseimg/Privi-iPhone6.svg",
    }
];
