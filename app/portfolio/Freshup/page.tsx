        ...
        <div className="w-full font-THICCCBOI">
            <div className="w-full" style={{ backgroundImage: "url('/images/polygon.png')" }}>
               ...
               ───────────────────────────────────────────── */}
                    ...
                    {/* --- THE RESULTS BANNER --- */}
                    <section className="w-full bg-gradient-to-r from-[#0B76E8] via-[#4048C9] to-[#7816A7] py-6 md:py-15 px-4 sm:px-6 lg:px-8">
                    ...
                    <section className="relative w-full py-20 md:py-32 px-4 overflow-hidden">
                        ...
                        <div className="max-w-7xl mx-auto relative z-10">
                            ...
                            <div className="flex flex-col lg:flex-row gap-16 md:gap-24 items-center">
                                ...
                                >
                                    {[
                                        "Join live voice chat rooms and engage in real-time conversations with people who share your passions and interests.",
                                        " Create and grow communities around cars, hobbies, lifestyles, trends, or any topic that brings people together socially.",
                                        "Share photos, videos, and thoughts while building meaningful connections through interactive social experiences.",
                                        ...
                                        >
                                            <div className="shrink-0">
                                                <div className="w-10 h-10 rounded-xl bg-gray-50 group-hover:bg-[#E8F7FC] flex items-center justify-center transition-colors duration-300">
                                                    <img src="/caseimg/likeblack.svg" className="w-6 h-6 group-hover:scale-110 transition-transform duration-300" alt="" />
                                                </div>
                                            </div>
                                            <div>
                                ...
                                >
                                    <div className="relative w-full max-w-[280px] sm:max-w-[360px] hover:-translate-y-4 transition-transform duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)]">
                                        ...
                                        <div className="absolute -right-8 sm:-right-[80px] top-[20%] w-[55%] z-0">
                                            <Image src="/caseimg/iPhone_11_a.svg" alt="App Preview Back" width={300} height={600} className="w-full h-auto drop-shadow-[0_25px_50px_rgba(0,0,0,0.25)]" priority />
                                        </div>
                                        {/* Front/Left Phone */}
                            ...
                            <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                                ...
                                >
                                    <div className="relative w-full max-w-[280px] sm:max-w-[360px] hover:-translate-y-4 hover:scale-[1.02] transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)]">
                                        ...
                                        {/* Back/Right Phone */}
                                        <div className="absolute -right-8 sm:-right-[80px] top-[20%] w-[55%] z-0">
                                            <Image src="/caseimg/iPhone_11_sol.svg" alt="App Preview Back" width={300} height={600} className="w-full h-auto drop-shadow-[0_25px_50px_rgba(0,0,0,0.25)]" priority />
                                        </div>
                                        {/* Front/Left Phone */}
                                        <div className="relative -left-8 sm:-left-[80px] w-[55%] z-10">
                                            <Image src="/caseimg/iPhone_11_sol2.svg" alt="App Preview Front" width={300} height={600} className="w-full h-auto drop-shadow-[0_25px_50px_rgba(0,0,0,0.35)]" priority />
                                        </div>
                                        {/* Spacer to prevent overlap clipping */}
                                        <div className="pb-[10%]"></div>
                                    </div>
                                ...
                                >
                                    {[
                                        "Advanced group and private voice chat features designed for smooth, engaging, and real-time social communication.",
                                        "Multimedia sharing capabilities that allow users to post photos, videos, and updates within their communities effortlessly.",
                                        "Community-driven networking tools including group creation, tagging, discussions, and interactive engagement features.",
                                        ...
                                        >
                                            <div className="shrink-0">
                                                <div className="w-10 h-10 rounded-full bg-white/10 group-hover:bg-[#32B9E9]/20 flex items-center justify-center transition-colors duration-300">
                                                    <img src="/caseimg/likewhite.svg" alt="icon" className="w-5 h-5 group-hover:scale-110 transition-transform duration-300" />
                                                </div>
                                            </div>
                                            <div>
               ...
               ───────────────────────────────────────────── */}
                   ...
                   7. TECHNOLOGY STACK
               ───────────────────────────────────────────── */}
                    <Technology projectName="Freshup application" projectType="mobile" />
