         ...
         <div className="w-full" style={{ backgroundImage: "url('/images/polygon.png')" }}>
            <div className="w-full font-THICCCBOI overflow-x-hidden">
               ...
               {/* ─────────────────────────────────────────────
                   1. HERO SECTION
               ───────────────────────────────────────────── */}
               <section className="relative w-full min-h-[500px] md:h-[700px] flex items-center justify-center pt-24 md:pt-0 mb-[40px] md:mb-[80px] px-3 sm:px-5 lg:px-7">
                  {/* Background Video */}
                  ...
                  <div className="relative z-20 text-center w-full max-w-7xl mx-auto flex flex-col items-center gap-4">
                     {/* Logo */}
               ...
               {/* --- THE RESULTS BANNER --- */}
               <section className="w-full bg-[#2a3e47] py-6 md:py-15 px-3 sm:px-5 lg:px-7">
