...
const AverageCost: React.FC = () => {
    ...
    return (
        <section className="text-black py-10 md:py-16 font-THICCCBOI px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">

                <div className="flex flex-col gap-4 text-center items-center justify-center sm:gap-5 relative z-10 max-w-7xl mx-auto">
                                ...
                                <div className="relative h-full rounded-[20px] p-[2px] transition-all duration-300">
                                    <div className="relative h-full rounded-[19px] bg-white p-6 md:p-8 flex flex-col shadow-sm border border-gray-100 overflow-hidden">
                                        <div>
                                            ...
                                            <h3 className="font-bold text-[18px] md:text-[20px] mb-3">
                                                {item.title}
                                            </h3>
