...
const Technologies = () => {
    return (
        <section className="px-4 mt-[100px] mb-[100px] text-black font-THICCCBOI max-w-7xl mx-auto overflow-hidden">
            <motion.div 
            ...
            >
                ...
                >
                    <div>
                        ...
                        <div className="flex gap-3 sm:gap-6 w-full overflow-x-auto no-scrollbar pb-4 pt-2">
