...
const WebDevelopmentProjects = () => {
    return (
        <section className='text-center py-10 font-THICCCBOI'>
            ...
            <p className='text-gray-500 max-w-6xl mx-auto mb-10 px-4 leading-relaxed text-sm md:text-[20px] font-THICCCBOI'>
