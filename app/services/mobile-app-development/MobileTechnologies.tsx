...
import { SiFlutter, SiKotlin, SiSwift, SiTypescript, SiFirebase } from 'react-icons/si'
            ...
            >
                ...
                >
                    <h2 className="text-[32px] sm:text-[40px] md:text-[48px] font-bold mb-4 leading-tight">
                        <span className="">Technologies</span> We <br /> Work With
                    </h2>
                    <p className="text-black text-[16px] sm:text-[18px] md:text-[20px] leading-relaxed">
                        We create top-notch mobile applications with our proficiency across leading iOS, Android, and cross-platform mobile development technologies.
                    </p>
                </motion.div>
                ...
                >
                    <div>
                        <h3 className="font-bold mb-6 flex items-center gap-2"><div className="w-2 h-2 bg-[#32B9E9] rounded-full"></div> Mobile & Cross-Platform</h3>
                        <div className="flex gap-6 sm:gap-6 lg:gap-8 w-full overflow-x-auto no-scrollbar pb-4 pt-2">
                            <div className="flex flex-col items-center justify-center gap-3 bg-white rounded-[20px] w-[75px] h-[90px] sm:w-[110px] sm:h-[120px] flex-shrink-0 border border-gray-100 hover:shadow-[0_8px_30px_rgba(50,185,233,0.15)] transition-all duration-300 hover:-translate-y-2 group">
                                ...
                                <span className="text-[11px] sm:text-[14px] font-medium text-gray-700 group-hover:text-black transition-colors">React Native</span>
                            </div>
                            <div className="flex flex-col items-center justify-center gap-3 bg-white rounded-[20px] w-[75px] h-[90px] sm:w-[110px] sm:h-[120px] flex-shrink-0 border border-gray-100 hover:shadow-[0_8px_30px_rgba(50,185,233,0.15)] transition-all duration-300 hover:-translate-y-2 group">
                                <SiFlutter className="w-8 h-8 sm:w-12 sm:h-12 text-[#02569B] transition-transform duration-300 group-hover:scale-110" />
                                <span className="text-[11px] sm:text-[14px] font-medium text-gray-700 group-hover:text-black transition-colors">Flutter</span>
                            </div>
                            <div className="flex flex-col items-center justify-center gap-3 bg-white rounded-[20px] w-[75px] h-[90px] sm:w-[110px] sm:h-[120px] flex-shrink-0 border border-gray-100 hover:shadow-[0_8px_30px_rgba(50,185,233,0.15)] transition-all duration-300 hover:-translate-y-2 group">
                                <SiSwift className="w-8 h-8 sm:w-12 sm:h-12 text-[#F05138] transition-transform duration-300 group-hover:scale-110" />
                                <span className="text-[11px] sm:text-[14px] font-medium text-gray-700 group-hover:text-black transition-colors">Swift (iOS)</span>
                            </div>
                            <div className="flex flex-col items-center justify-center gap-3 bg-white rounded-[20px] w-[75px] h-[90px] sm:w-[110px] sm:h-[120px] flex-shrink-0 border border-gray-100 hover:shadow-[0_8px_30px_rgba(50,185,233,0.15)] transition-all duration-300 hover:-translate-y-2 group">
                                <SiKotlin className="w-8 h-8 sm:w-12 sm:h-12 text-[#7F52FF] transition-transform duration-300 group-hover:scale-110" />
                                <span className="text-[11px] sm:text-[14px] font-medium text-gray-700 group-hover:text-black transition-colors">Kotlin</span>
                            </div>
                        </div>
                    </div>
                    <div>
                        <h3 className="font-bold mb-6 flex items-center gap-2"><div className="w-2 h-2 bg-[#32B9E9] rounded-full"></div> Backend & Cloud</h3>
                        <div className="flex gap-6 sm:gap-6 lg:gap-8 w-full overflow-x-auto no-scrollbar pb-4 pt-2">
                            <div className="flex flex-col items-center justify-center gap-3 bg-white rounded-[20px] w-[75px] h-[90px] sm:w-[110px] sm:h-[120px] flex-shrink-0 border border-gray-100 hover:shadow-[0_8px_30px_rgba(50,185,233,0.15)] transition-all duration-300 hover:-translate-y-2 group">
                                <SiFirebase className="w-8 h-8 sm:w-12 sm:h-12 text-[#FFCA28] transition-transform duration-300 group-hover:scale-110" />
                                <span className="text-[11px] sm:text-[14px] font-medium text-gray-700 group-hover:text-black transition-colors">Firebase</span>
                            </div>
                            <div className="flex flex-col items-center justify-center gap-3 bg-white rounded-[20px] w-[75px] h-[90px] sm:w-[110px] sm:h-[120px] flex-shrink-0 border border-gray-100 hover:shadow-[0_8px_30px_rgba(50,185,233,0.15)] transition-all duration-300 hover:-translate-y-2 group">
