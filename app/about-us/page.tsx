  ...
  return (
    <div className='overflow-hidden' style={{
      ...
      <div className="font-THICCCBOI">
        ...
        >
          <div className="relative bg-[url('/images/about_bg_img.jpg')] bg-cover bg-center w-full min-h-96 sm:min-h-[500px] lg:min-h-[600px] py-8 sm:py-12 lg:py-16 text-center flex flex-col justify-center items-center px-4">
