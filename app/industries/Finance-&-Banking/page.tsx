...
const features = [
    {
        img: "/Letimg/fun.svg",
        title: "Finance App & Web Development",
        desc: "Build secure and user-friendly finance platforms tailored for banks, fintech companies, financial institutions, and digital payment services.",
    },
    {
        img: "/Letimg/fun.svg",
        title: "Digital Banking Solutions",
        desc: "Enable seamless banking experiences with secure transactions, account management, analytics, and real-time financial services.",
    },
    {
        img: "/Letimg/fun.svg",
        title: "Payment & Transaction Management Systems",
        desc: "Develop reliable payment solutions with transaction tracking, fraud protection, payment gateway integration, and financial reporting features.",
    },
    {
        img: "/Letimg/fun.svg",
        title: "Finance Platform Modernization & Support",
        desc: "Upgrade outdated banking and finance systems with scalable, secure, and performance-driven digital solutions.",
    },
];
                ...
                <section className="relative w-full min-h-[500px] md:min-h-[600px] flex items-center pt-24 md:pt-0">
                    <div className="relative z-10 w-full max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16 py-12 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="text-center lg:text-left">
                            ...
                            >
                                {"Finance & Banking Development Solutions".split(" ").map((word, i) => (
                                    <motion.span
                                        key={i}
                            ...
                            <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed mb-8 max-w-2xl mx-auto lg:mx-0">
                                We build secure and scalable finance and banking web and mobile solutions focused on digital transactions, operational efficiency, customer engagement, and modern financial experiences.
                            </p>
                        ...
                        <div className="relative flex justify-center items-center">
                            <div className="relative w-full max-w-[320px] sm:max-w-[450px] lg:max-w-[550px] aspect-[4/3] transition-transform duration-500 hover:scale-[1.02]">
                                <img src="/images/Finance-&-Bankinglogo.svg" alt="Fintech Mockup" className="w-full h-full object-contain" />
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="w-full max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16">
                        <div className="max-w-7xl mx-auto lg:mx-0 text-center lg:text-left mb-12 md:mb-20">
                            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight tracking-tight mb-6">
                                Scale Your Financial Services with Appadvent’s Expert Finance & Banking Development Services
                            </h2>
                            <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
                                We create modern finance and banking solutions designed to simplify financial operations, enhance transaction security, improve customer experiences, and support scalable digital banking systems.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                            ...
                            <div className="flex justify-center items-center relative order-1 lg:order-2">
                                <div className="relative w-full max-w-[350px] md:max-w-[450px] transition-transform duration-500 hover:scale-[1.03]">
                                    <img src="/Letimg/Finance-&-Banking-about.svg" alt="Crypto Wallet" className="w-full h-auto drop-shadow-2xl" />
        ...
        ══════════════════════════════════════════════════════════════ */}
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white text-center leading-tight tracking-tight mb-12">
                        Our Finance & Banking Software Development Framework
                    </h2>
                                ...
                                <TiltCard className="h-full">
                                    <div className="block h-full group" onMouseEnter={() => handleHover(idx)}>
                                        <div className="relative h-full rounded-[20px] p-[1.5px] transition-all duration-500 bg-transparent hover:bg-[#F0F0F0] group-hover:bg-gradient-to-br group-hover:from-[#32B9E9] group-hover:via-[#6DD5FA] group-hover:to-[#2193b0]">
                                            <div
                                                className="relative h-full rounded-[19.5px] bg-white p-3 lg:p-6 flex flex-col shadow-sm transition-all duration-500 group-hover:shadow-[0_8px_40px_rgba(50,185,233,0.12)] overflow-hidden"
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 mb-[40px] lg:mb-[40px] items-start">
                            <div>
                                <h2 className="text-3xl sm:text-[42px] lg:text-[42px] font-bold text-gray-900 leading-[1.25] tracking-tight">
                                    Scale Your Healthcare Business with Appadvent’s
                                    <span className='text-[#32B9E9]'> Expert Health & Pharmacy </span>
